...
const SIGNATURE_CONTRACTS: Dictionary = {
	...
	&"can_build_worker_factory": {"args": [&"planet_id", &"cost_resource", &"cost_amount"], "required": 3},
	&"build_worker_factory": {"args": [&"planet_id", &"cost_resource", &"cost_amount"], "required": 3},
