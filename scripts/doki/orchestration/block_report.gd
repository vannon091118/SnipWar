...
func _build_report(
	...
	lines.append("")
	lines.append("## Post-Commit Lifecycle Hinweis")
	lines.append("")
	lines.append("Der post-commit Hook schreibt nach jedem Commit narrative Artefakte")
	lines.append("(narrative_chain.json, change_index.json, arcs.json, CHANGELOG.md).")
	lines.append("Diese Dateien sind GESTAGT aber NICHT im aktuellen Commit.")
	lines.append("Sie gehoeren zum NAECHSTEN Commit — das ist normal.")
	lines.append("")
