...
func _build_concepts() -> void:
	...
	_add_concept("commit_layer", "tooling", ["DOKI_CommitOrchestrator", "DOKI_RngEngine", "DOKI_XorShift128", "DOKI_ChainStore", "DOKI_SessionStore", "DOKI_ChangeIndexStore", "DOKI_NarratorCatalog", "DOKI_MoodOverlay", "DOKI_VoiceComposer", "DOKI_RelationshipEngine", "DOKI_SidePlotEngine", "DOKI_ArcEngine", "DOKI_ChangeIndexEngine", "DOKI_Verifier", "DOKI_SessionBuilder", "DOKI_MessageBuilder", "DOKI_ArtifactWriter", "DOKI_GitHelper", "DOKI_PrepareFlow", "DOKI_FinishFlow", "DOKI_FinalizeFlow", "DOKI_GateFlow", "DOKI_StatusFlow"], ["prepare", "finish", "finalize", "repair", "verify_only", "gate", "derive", "djb2", "append_entry", "validate"], "DOKI CommitLayer: deterministic narrative commit gate (prepare/finish/finalize, 9 checks, chain store)", ["commit", "doki", "narrator", "narrative", "chain", "composite", "gate", "commitlayer", "commit layer"])
	...
	_add_concept("world_generation", "world", ["WorldConfig", "WorldGenerator", "WorldBootstrap", "SeededLayout", "ChunkCoordinator", "PlanetCatalog", "PlanetDefinition", "SectorClassifier", "SectorFlavor", "SectorFlavorCatalog", "ScenarioCatalog", "ScenarioDefinition", "MapDefinition", "BackgroundConfig", "BackgroundNebulaDefinition", "AssetLibrary", "ConceptIndex", "ClusterData", "Sun", "RunPreparation"], ["generate_catalog", "set_layout_seed", "reset_for_infinite_world", "resolved_target_planet_count", "is_infinite_world", "generate_clusters", "is_cluster_generation_enabled", "get_clusters", "get_sun_nodes", "is_void_position", "get_cluster_lod"], "Seeded world generation, catalogs, chunks, sectors, cluster-void (Makulatur) system", ["world", "welt", "layout", "seed", "catalog", "katalog", "chunk", "infinite", "unendlich", "sector", "generator", "cluster", "void", "makulatur", "sun", "sonne", "glow"])
	_add_concept("planets", "planets", ["Planet", "PlanetNetwork", "PlanetNetworkUI", "PlanetWorldUI", "PlanetGrid", "PlanetProcedural", "PlanetArrivalResolver", "SelectionService", "ContextMenuBuilder", "PlanetDetails", "PlanetDetailOrbit", "PlanetTraitAggregator", "PlanetView", "PlanetDetailDefinition", "PlanetDetailFidelity", "PlanetDetailProfile", "PlanetGridCell", "PlanetGridConfig", "PlanetSizeProfile", "PlanetUpgradeDefinition", "PlanetUpgradeCatalog", "MeteorConfig"], ["register_planet", "set_faction", "homeworld_for", "discover_planet", "scan_planet", "known_planets_of"], "Planet lifecycle, ownership, discovery and planet UI", ["planet", "planetoid", "homeworld", "heimwelt", "faction", "fraktion", "scan", "discover", "discovery", "capture"])
	...
	_add_concept("events_signals", "events", ["GameEventBus"], ["emit_event", "subscribe", "push", "log_silent"], "Event log, unified event bus, toast messages and signals", ["event", "eventlog", "eventbus", "bus", "log", "signal", "message"])
	_add_concept("historical_simulation", "events", ["HistorySimulator", "WorldState", "HistoryEvent", "HistoryEventFactory", "HistoricalSnapshot", "PlaybackController", "HistoricalRenderer", "HistoricalWorldBootstrap", "ChronicleSaveData", "ChronicleTemplateResolver", "HistoricalPerspective", "ImportanceEvaluator", "CauseTracker", "ChainDetector", "EventChain", "CharacterBiography", "FigureCatalog", "EraClassifier", "ChronicleArchiveView", "SimulationOverlay", "FactionAI"], ["simulate", "simulate_with_snapshots", "reset", "snapshot", "restore", "detect_chains", "auto_link", "resolve_text", "show_snapshot", "load_snapshots"], "Deterministic historical simulation, facts, causality, playback, rendering and chronicle archive", ["history", "historical", "chronicle", "chronik", "world history", "weltgeschichte", "backstory", "vorgeschichte", "biography", "biografie", "playback"])
