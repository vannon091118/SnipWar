...
func _build_concepts() -> void:
	...
	_add_concept("world_generation", "world", ["WorldConfig", "WorldGenerator", "WorldBootstrap", "SeededLayout", "ChunkCoordinator", "PlanetCatalog", "PlanetDefinition", "SectorClassifier", "SectorFlavor", "SectorFlavorCatalog", "ScenarioCatalog", "ScenarioDefinition", "MapDefinition", "BackgroundConfig", "BackgroundNebulaDefinition", "AssetLibrary", "ConceptIndex", "ClusterData", "Sun"], ["generate_catalog", "set_layout_seed", "reset_for_infinite_world", "resolved_target_planet_count", "is_infinite_world", "generate_clusters", "is_cluster_generation_enabled", "get_clusters", "get_sun_nodes", "is_void_position", "get_cluster_lod"], "Seeded world generation, catalogs, chunks, sectors, cluster-void (Makulatur) system", ["world", "welt", "layout", "seed", "catalog", "katalog", "chunk", "infinite", "unendlich", "sector", "generator", "cluster", "void", "makulatur", "sun", "sonne", "glow"])
