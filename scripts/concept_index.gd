...
func _build_concepts() -> void:
	...
	_add_concept("ui_systems", "ui", ["PlanetPanel", "VaultBar", "MainMenu", "PauseMenu", "MessageFeed", "ModalCoordinator", "PaperDossier", "UIThemeConfig", "FloatingText", "IngamePlayerControls", "ModuleHpBar", "SelectionActionTooltip", "UIBaseUtils", "CaptureDecisionOverlay", "EconomyWindow", "FleetOverview", "ControlField", "LayoutCoordinator", "InputHintOverlay"], ["setup", "show_panel", "hide_panel", "refresh"], "Menus, panels, overlays, messages and theming", ["menu", "panel", "button", "overlay", "tooltip", "toast", "dossier", "pause", "theme"])
