...
var _PATH_CONTRACTS: Array = [
	...
	{"glob": "scripts/*.sh", "contracts": ["preflight"]},
	...
	{"glob": "scripts/verify.py", "contracts": ["preflight"]},
	# Gelöschte Verifikations-Infrastruktur (Deletions müssen ebenfalls auflösbar sein,
	# sonst fail-closed der Scope auf unknown_impact).
	{"glob": "scripts/check.gd", "contracts": ["preflight"]},
	{"glob": "scripts/preflight_lock.gd", "contracts": ["preflight"]},
	{"glob": "scripts/preflight_v2_runner.gd", "contracts": ["preflight"]},
