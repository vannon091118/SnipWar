...
> Letzte Aktualisierung: `2026-08-29T02:23:20` | Chain-Eintrag: `c72` | Arc: `a36`
...
|-----------|---------|-----------|
| `FRUSTRATION_WEIGHT` | 1.2 | **2.0** |
| `DECAY_FACTOR` | 0.1 | **0.02** |
| `RESPECT_WEIGHT` | 0.5 | **0.3** |
