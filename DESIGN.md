...
- **Panel-Menü:** Die Ressourcen-HUD bleibt im verfügbaren Kartenraum und wird nicht vom rechten Planet-Panel überlagert. Ein kompakter Tab öffnet/schließt das Panel; ein Planetenklick öffnet es automatisch, `Escape` schließt es wieder. Der Panelinhalt scrollt, Upgrade-Zweige sind einzeln auf-/zuklappbar und der aktive Planet bleibt der Kontext für Dispatch und Ausbau.
